        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_AspNetUsers_InitialOwnerId",
                        column: x => x.InitialOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripOrganisators", x => new { x.TripId, x.UserId });
                    table.ForeignKey(
                        name: "FK_TripOrganisators_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripOrganisators_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripOrganisators_UserId",
                table: "TripOrganisators",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_InitialOwnerId",
                table: "Trips",
                column: "InitialOwnerId");
        }
